...
<div class="container my-5">
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card">
                <div class="card-header"><strong>{{ __('app.titles.restablecer') }}</strong></div>
                ...
                <div class="card-body">
                    <form action="{{ route('password.update') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus required>
